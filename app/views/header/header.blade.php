                                            ...
                                            <div class="fright">
                                                ...
                                                <div class="noty fleft">
                                                    ...
                                                    <a href="<?php echo url(); ?>/accepttherequest?accepttype=admin">
                                                        <span class="circ">{{ $admin }}</span>	<span id="txt_admingroup">Group admin request</span>
                                                    </a>
                                                    <a href="<?php echo url(); ?>/accepttherequest?accepttype=user">
                                                        <span class="circ">{{$user}}</span>	<span id="txt_adminrequest">Group member request</span>
                                                    </a>
