                ...
                if ($showjoinbtn == 'no') {
                    ...
                    <tbody>
                        ...
                        <td class="tr_wid_id"><?php
							...
							<td> {{ $savegroupmembers[$i]['email'] }}  </td>
							...
							?>
							 ...
							 <a href="{{ $facurl }}" target="_blank">
							<img src="{{ URL::to('/assets/inner/img/facebook_icons.png') }}" width="25" height="25"  style="background:#000000;"> 
							</a> 
							...
							<a href="{{ $twiturl }}" target="_blank">
							<img src="{{ URL::to('/assets/inner/img/twitter_icons.png') }}" width="25" height="25" style="background:#000000;">
							</a> 
							...
							<img src="{{ URL::to('/assets/inner/img/instagram_icons.png') }}" width="25" height="25"  style="background:#000000;">
							</a>
							<?php } ?>
							</td>
