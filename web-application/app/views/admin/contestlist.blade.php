...
function contestdelete(contestid,rowno) {
                                           ...
                                           /* $createdowner = User::select('firstname','lastname','username')->where('ID',$usercontestlist[$i]['createdby'])->get(); */
                                            ...
                                            <tr id="row_{{ $i }}">
                                               ...
                                               <?php /* <td><?php if($createdowner[0]['firstname']!=''){ echo $createdowner[0]['firstname'].' '.$createdowner[0]['lastname'];  }else{ echo $createdowner[0]['username']; } ?></td>  */ ?>
                                                ...
                                                <td class="tr_wid_button1" align="center"><a href="<?php echo url(); ?>/contestparticipantlist/<?php echo $usercontestlist[$i]['ID']; ?>" class="view-link" title="View"></a></td>
                                                <td class="tr_wid_button1" align="center"><?php if (Auth::user()->ID == 1) { ?><a href="{{ URL::to('edit_contest/'.$usercontestlist[$i]['ID']) }}" class="edit-link" title="Edit"></a><?php } ?></td>
                                                <td align="center"><?php if (Auth::user()->ID == 1) { ?><a href="#" class="del-link" onclick="contestdelete('<?php echo $usercontestlist[$i]['ID']; ?>','<?php echo $i; ?>')" title="Delete" ></a><?php } ?></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>        
