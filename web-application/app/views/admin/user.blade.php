...
function userdelete(userid,rowno) {
                                        ...
                                        for ($i = 0; $i < count($userlist); $i++) {
                                            if ($userlist[$i]['ID'] != 1) {
                                                ...
                                                <tr id="row_{{ $i }}">
                                                    ...
                                                    <td align="center"><a href="<?php echo url(); ?>/viewusercontest/<?php echo $userlist[$i]['ID']; ?>" class="contest-link" title="View contest"></a></td>
                                                    <td align="center"><a href="#" onclick="changeactive('<?php echo $userlist[$i]['ID']; ?>')" <?php
                                                if ($userlist[$i]['status'] == 1) {
                                                    echo 'style="background-color:green;" title="Active"';
                                                } else {
                                                    echo 'style="background-color:red;" title="Inactive"';
                                                }
                                                ?> class="add-link backclr_<?php echo $userlist[$i]['ID']; ?>"></a></td>
                                                    <td class="tr_wid_button1" align="center"><a href="<?php echo url(); ?>/other_profile/<?php echo $userlist[$i]['ID']; ?>" class="view-link" title="View"></a></td>
                                                    <td class="tr_wid_button1" align="center"><?php if (Auth::user()->ID == 1) { ?><a href="<?php echo url(); ?>/edit_profile/<?php echo $userlist[$i]['ID']; ?>" class="edit-link" title="Edit"></a><?php } ?></td>
                                                    <td align="center"><?php if (Auth::user()->ID == 1) { ?><a href="#" class="del-link" onclick="userdelete('<?php echo $userlist[$i]['ID']; ?>','<?php echo $i; ?>')" title="Delete" ></a><?php } ?></td>
                                                </tr>
        <?php
    }
}
?>
                                    ...
                                    <div id="tab-body-2" class="tab-body">
                                        ...
                                        <form id="editprofile" name="edit_profile_update" enctype="multipart/form-data"  action="{{ URL::to('/adduser') }}" method="post" class="form_mid">
                                            ...
                                            $userInterest = InterestCategoryModel::where('status',1)->lists('Interest_name', 'Interest_id');
                                            ...
                                            <div class="loginform loginbox mar2">
                                                ...
                                                <!--<input type="file" name="profilepicture" value="Upload New Image" class="inp_file" />-->
                                                    ...
                                                    <p>
                                                    <div class="inp_pfix aft_rdo_mar1" style="margin-top:53px;"><img src="{{ URL::to($assets_path.'img/date_icons.png') }}" width="25" height="25"></div>
                                                    ...
                                                    <p>
                                                    <div class="inp_pfix aft_rdo_mar1" style="margin-top:53px;"><img src="{{ URL::to($assets_path.'img/kids_icons.png') }}" width="25" height="25"></div>
                                                ...
                                                <legend class="radius"><div class="leg_head txt_timezone">Time Zone</div>
													...
													?>
													{{ Form::select('dateformat',$dateformat,isset($old_data['dateformat'])?$old_data['dateformat']:'', array('class'=>'SlectBox testsel radius','placeholder'=>'Select Date format','title'=>'Select Dateformat')) }}
