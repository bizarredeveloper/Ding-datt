...
<div class="tabs-wrapper1" style=" margin: 20px 8% -175px;">
    <!--<div class="tab_desk">-->
    <input type="radio" name="tab" id="tab1" class="tab-head" checked="checked" <?php if ($tab == "profilinfo") {
    echo "checked";
} ?>  />
    <label for="tab1" id="tb1"><span id="txt_submenu_profile">Profile Info</span></label>
    <input type="radio" name="tab" id="tab2" class="tab-head" <?php if ($tab == "history") {
    echo "checked";
} ?> />
    <label for="tab2" id="tb2"><span id="txt_submenu_history">History</span></label>
    <input type="radio" name="tab" id="tab3" class="tab-head" <?php if ($tab == "Followers") {
    echo "checked";
} ?> />
    <label for="tab3" id="tb3"><span id="txt_followers">Followers</span></label>
    <input type="radio" name="tab" id="tab4" class="tab-head" <?php if ($tab == "following") {
    echo "checked";
} ?> />
    <label for="tab4" id="tb4"><span id="txt_following">Following</span></label>
    <input type="radio" name="tab" id="tab5" class="tab-head" <?php if ($tab == "group") {
    echo "checked";
} ?> />
    <label for="tab5" id="tb5"><span class="mnu_group">Group</span></label>
    <!--</div>-->
  ...
  <!--  <div id="subtab_div" class="con_cat_right mbnone" >
	...
	<!-- <label > -->
<div style="width:18% !important; margin:10px 0 0 0"><!-- class="con_cat_right" -->
        <?php
        if ($profileid == Auth::user()->ID) {
            $authuserid = Auth::user()->ID;
            ?>
            <a href="<?php echo url() . '/edit_profile/' . $authuserid; ?>" style="width:100% !important; text-decoration:none;"><label for="tab6" id="txt_editprofile"  style="width: 100% !important;"><span id="txt_submenu_editprofile">Edit Profile</span></label></a>

    <?php
}
?>
        <a onclick="goback()" ><label for="tab7" id="txt_editprofile" style="width:100% !important;">Back</label></a>
</div>
<!--  </label> -->
    ...
    <div class="tab-body-wrapper op_wrapper">
...
?>
                            <div class="inp_pfix aft_rdo_mar1" style="margin-top:57px;"><img src="{{ URL::to('/assets/inner/img/date_icons.png') }}" width="25" height="25"></div>
                            ...
                            <div class="rdogrp">
                                <label class="rad_gen"><strong><span id="txt_maritalstatus">Marital</span></strong></label>
                                <div class="mb_brk"></div>
                                <input type="radio" id="ms1" name="ms" disabled value="0" <?php echo ($profiledetail[0]['maritalstatus'] == 0) ? "checked" : ""; ?> >
                                <label for="ms1" id="txt_single" class="rad_gen">Single</label>
                                <input type="radio" id="ms2" name="ms"value="1" disabled <?php echo ($profiledetail[0]['maritalstatus'] == 1) ? "checked" : ""; ?>>
                                <label for="ms2" id="txt_married" class="rad_gen">Married</label>
                            </div>

                            <div class="clearfix"></div>

                            <p>
                            <div class="inp_pfix aft_rdo_mar1" style="margin-top:56px;"><img src="{{ URL::to('/assets/inner/img/kids_icons.png') }}" width="25" height="25"></div>
...
?>
                        ...
                        <legend class="radius"><div class="leg_head" id="txt_timezone"  >Time Zone</div>
							...
							?>
							{{ Form::select('dateformat',$dateformat,isset($old_data['dateformat'])?$old_data['dateformat']:$profiledetail[0]['dateformat'], array('class'=>'SlectBox testsel radius','placeholder'=>'Select Date format','title'=>'Select Dateformat')) }}
							</p>
