...
/* Admin controll all the user process */
...
class adminController extends BaseController {
    ...
    public function adduser() {
        ...
        if ($validation->passes()) {
            ...
            for ($i = 0; $i < $interest_length; $i++) {
                $interes['user_id'] = $affectedRows->ID;
            ...
            foreach ($languageDetails as $key => $val) {
                ...
                elseif (in_array($val['ctrlCaptionId'], ['alert_enterpassword', 'alert_minpass5', 'alert_passconfnotmat']))
    ...
    public function userdelete() {
        ...
        for ($k = 0; $k < count($contestcnt); $k++) {
            ...
            for ($p = 0; $p < count($conpartdet); $p++) {
				...
				reportflagModel::where('contest_participant_id',$conpartdet[$p]['ID'])->delete();
            }
			...
			reportflagModel::where('contest_id',$contestcnt[$k]['ID'])->delete();
        }
        ...
        for ($p = 0; $p < count($contestparticipant); $p++) {
			...
			reportflagModel::where('contest_participant_id',$contestparticipant[$p]['ID'])->delete();
        }
        ///////////////Group //////////////////
		...
		reportflagModel::where('postedby_userid',$userid)->delete();
		reportflagModel::where('report_userid',$userid)->delete();
    ...
    public function activecontest() {
        ...
        if ($checkstatus == 1) {
            ...
            $affectedRows = contestModel::where('ID', $contestid)->update($updatedetails);
					...
					$details = '<table width="100%"><tr style="height:10px;"><td></td></tr><tr><td style="height:30px;">
								Your contest ' . $contestname . ' is deactivated by admin.
								</td></tr>
								<tr><td style="height:45px;"><a href="' . URL() . '"><img src="' . URL::to('assets/inner/images/vist_dingdatt.png') . '" width="120" height="30" /></a></td></tr>
								<tr><td style="border-top:#005377 1px solid; height:30px;"><span style="font-size:12px;color: #5b5b5b;padding:0px 10px;line-height:22px;text-align:center;">This is auto generated mail and do not reply to this mail.</span></td></tr>
								</table>';
            ...
            $affectedRows = contestModel::where('ID', $contestid)->update($updatedetails);
									...
									$details = '<table width="100%"><tr style="height:10px;"><td></td></tr><tr><td style="height:30px;">
								Your contest ' . $contestname . ' is activated by admin.
								</td></tr>
								<tr><td style="height:45px;"><a href="' . URL() . '"><img src="' . URL::to('assets/inner/images/vist_dingdatt.png') . '" width="120" height="30" /></a></td></tr>
								<tr><td style="border-top:#005377 1px solid; height:30px;"><span style="font-size:12px;color: #5b5b5b;padding:0px 10px;line-height:22px;text-align:center;">This is auto generated mail and do not reply to this mail.</span></td></tr>
								</table>';
    ...
    public function removecontestparticipant() {
        ...
        if ($participantid) {
            ...
            if ($leaderboard > 0)
				...
				reportflagModel::where('contest_participant_id',$contestparticipantid)->delete();
    ...
    public function contestdelete() {
		...
		$details = '<table width="100%"><tr style="height:10px;"><td></td></tr><tr><td style="height:30px;">
								Your contest ' . $contestname . ' is deleted by admin.
								</td></tr>
								<tr><td style="height:45px;"><a href="' . URL() . '"><img src="' . URL::to('assets/inner/images/vist_dingdatt.png') . '" width="120" height="30" /></a></td></tr>
								<tr><td style="border-top:#005377 1px solid; height:30px;"><span style="font-size:12px;color: #5b5b5b;padding:0px 10px;line-height:22px;text-align:center;">This is auto generated mail and do not reply to this mail.</span></td></tr>
								</table>';
		...
		reportflagModel::where('contest_id',$data)->delete();
    ...
    ///// Admin send mail to contest owner ///////////
