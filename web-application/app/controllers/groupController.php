<?php
/* This controller works crud process for group and group members   */
class groupController extends BaseController {
    ...
    public function groupdelete() {
        ...
        if ($group > 0) {
            ...
            ///// Group member details ///////////
					...
					$groupdetails = '<table width="100%"><tr style="height:10px;"><td></td></tr><tr><td style="height:30px;">
        ...
        if ($validation->passes()) {
            ...
            if ($affectedRows) {
                ...
                if (Auth::user()->ID == 1) {
                    ...
                    $groupdetails = '<div style="font-size:12px;	color: #000000;	float:left;padding:5px 0px; width:100%;">Your group <b>"' . $groupname . '"</b> is edited by admin  </div><div style="float:left;">
						<table width="100%" height="95" border="0" style="margin-bottom:10px;float:left;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;">
					  <tr>
						<td style="font-size:12px;color:#3BBA00; width:13%; !important;font-weight:bold;">Group Name:</td>
						<td style="font-size:12px;color: #5d5d5d;font-weight:bold; ">' . $groupname . '</td>
					  </tr>
					  <tr>
						<td style="font-size:12px;color: #3BBA00; width:13%; !important; font-weight:bold;">Group Type:</td>
						<td style="font-size:12px;color: #5d5d5d;font-weight:bold;">' . $savegroup[0]['grouptype'] . '</td>
					  </tr>
					   <tr>
						<td style="font-size:12px;color: #3BBA00; width:13%; !important; font-weight:bold;">Group status </td>
						<td style="font-size:12px;color: #5d5d5d;font-weight:bold;">' . $status . '</td>
					  </tr>
					  
					  <tr><td colspan="2" style="height:45px;" ><a href="' . URL::to('viewgroupmember/' . $groupowneruserid) . '"><img src="' . URL::to('assets/inner/images/vist_dingdatt.png') . '" width="120" height="30" /></a></td></tr>
								
								
					  	
					</table>
					<div style="border-top:#005377 1px solid; "><span style="font-size:12px;color: #5b5b5b;padding:10px 0px;line-height:22px;text-align:left;">This is auto generated mail and do not reply to this mail.</span></div>
					</div>';
    ...
    public function joinintogroup($data = Null) {
        ...
        if ($alreadymember) {
            ...
            if ($grouptype[0]['grouptype'] == 'open') {
                ...
                $checkalreadyinvited = invitememberforgroupModel::where('group_id', $data)->where('invitetype', 'u')->where('user_id',$authuserid)->get()->count();
    ...
    public function exitgroup() {
       ...
       $searchedgroup = '';
	   $er_data['message'] = 'You are exit from that group';
        return Redirect::to('group')->with('searchedgroup', $searchedgroup)->with('er_data',$er_data);
...
$groupdetailsactive = '<table width="100%"><tr style="height:10px;"><td></td></tr><tr><td style="height:30px;">
								Your group <b>"' . $groupname . '"</b> is activated by admin  
								</td></tr>
								<tr><td style="height:30px;">Group Name: ' . $groupname . '</td></tr>
								<tr><td style="height:30px;">Group Type: ' . $savegroup[0]['grouptype'] . '</td></tr>
								<tr><td style="height:30px;">Group status: Active </td></tr>
								<tr><td style="height:45px;"><a href="' . URL::to('viewgroupmember/' . $groupowneruserid) . '"><img src="' . URL::to('assets/inner/images/vist_dingdatt.png') . '" width="120" height="30" /></a></td></tr>
								<tr><td style="border-top:#005377 1px solid; height:30px;"><span style="font-size:12px;color: #5b5b5b;padding:0px 10px;line-height:22px;text-align:center;">This is auto generated mail and do not reply to this mail.</span></td></tr>
								</table>';
        ...
        /* $groupdetailsdeactive = '<div style="font-size:12px;	color: #000000;	float:left;padding:10px 2px;width:100%;margin:15px;">Your group <b>"' . $groupname . '"</b> is deactivated by admin  </div><div styel"float:left;">
					...
					$groupdetailsdeactive = '<table width="100%"><tr style="height:10px;"><td></td></tr><tr><td style="height:30px;">
								Your group <b>"' . $groupname . '"</b> is deactivated by admin  
								</td></tr>
								<tr><td style="height:30px;">Group Name: ' . $groupname . '</td></tr>
								<tr><td style="height:30px;">Group Type: ' . $savegroup[0]['grouptype'] . '</td></tr>
								<tr><td style="height:30px;">Group status: Inactive </td></tr>
								<tr><td style="height:45px;"><a href="' . URL::to('viewgroupmember/' . $groupowneruserid) . '"><img src="' . URL::to('assets/inner/images/vist_dingdatt.png') . '" width="120" height="30" /></a></td></tr>
								<tr><td style="border-top:#005377 1px solid; height:30px;"><span style="font-size:12px;color: #5b5b5b;padding:0px 10px;line-height:22px;text-align:center;">This is auto generated mail and do not reply to this mail.</span></td></tr>
								</table>';
	...
	public function redirectsoial(){
	

	return $redirectdata= $_GET['social'];
	return Redirect::away($redirectdata);
        ...
        Mail::send([], array('email' => $email, 'groupownername' => $groupownername, 'groupname' => $groupname, 'group_id' => $group_id, 'membername' => $membername, 'groupdetails' => $groupdetails), function($message) use ($email, $groupownername, $groupname, $group_id, $membername, $groupdetails) {
			...
			/* $mail_body = '<style>.thank{text-align:center; width:100%;}
						 ...
						 <body style="font-family:Arial, sans-serif; margin:0px auto; padding:0px;">
							...
							<div style="background:#ffffff;float:left;padding:10px 20px;margin:1px 1%; width:100%;" >
								<div class="thank" style="font-size:16px;color: #078AC2;font-weight:bold;float:left;width:100%;margin-top:10px;text-align:left; padding:10px 2px;">Dear ' . $groupownername . '</div>
