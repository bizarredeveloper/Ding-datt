...
public abstract class AbstractGetNameTask extends AsyncTask<Void, Void, Void> {
	...
	public interface ReturnGooglePlusData {
		public void ReturnJsonData(String sJson);
	}

	protected AbstractGetNameTask(Activity activity, String email,
			String scope, ReturnGooglePlusData listener) {
	...
	private String getFirstName(String jsonResponse) throws JSONException {
		...
		listener.ReturnJsonData(jsonResponse);
