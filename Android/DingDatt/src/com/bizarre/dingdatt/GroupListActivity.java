...
public class GroupListActivity extends FragmentActivity {
	...
	SearchListen listen;
	GroupListFragment groupListFragment = null;
	public static Activity grouplist;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		groupListFragment = new GroupListFragment(this);

		if (savedInstanceState == null) {

			getSupportFragmentManager().beginTransaction()
					.replace(R.id.content_frame, groupListFragment).commit();
		}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		SearchView.OnQueryTextListener queryTextListener = new SearchView.OnQueryTextListener() {
			public boolean onQueryTextChange(String newText) {
				...
				groupListFragment.onGetGroupsByFilterText(newText);
				return true;
			}
	...
	public interface SearchListen {
		...
		public void onSearchListen(String text);
	}
}