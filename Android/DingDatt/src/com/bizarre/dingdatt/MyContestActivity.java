...
public class MyContestActivity extends FragmentActivity {
	...
	int contest_id = 0;
	public static Activity mycontest;
	private MyContestFragment fragment;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fragment = new MyContestFragment(this);
		...
		Main.SetTitle(getActionBar().getCustomView(), CommonConfig.MY_CONTEST);
